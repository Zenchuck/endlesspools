...
//This looks like the starting point of custom JS code in this example
    //
    //
    //
    //
...
var config = {
    ...
    OPTION_ORDER: [
        'option_bracelet_rubberblue',
        'option_bracelet_cuir',
        'option_bracelet_rubberwhite',
        'option_coque_silverrough',
        'option_coque_silverglossy',
        'option_coque_goldgloss',
    ]
};
        ...
        this._api.getNodeMap(function(err, result) {
            ...
            for (var i = 0, l = config.OPTION_PREFIXES.length; i < l; i++) {
                ...
                if (prefix === 'option_bracelet_') {
                    $('.options').append('<h2>Choose Extra</h2>');
                }
                if (prefix === 'option_coque_') {
                    $('.options').append('<h2>Choose Skirt</h2>');
                }
