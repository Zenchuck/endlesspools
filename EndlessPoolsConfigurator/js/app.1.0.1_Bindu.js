...
},{"./views/App":8,"backbone":2,"jquery":3,"underscore":4}],2:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
var config = {
    URLID: '6bcfb343d7a748dab554d9065c7e3084',
    //URLID: 'b5cfed180f6643c395de8157c52e0afe',
	//URLID: '1086a595cd794438945b2fbb6ed621f3',
    ...
    OPTION_ORDER: [
        ...
        'option_bracelet_sphere',
        'option_bracelet_torus',
        'option_bracelet_cube',
        'option_bracelet_cylinder',
    ],
    
    // var OPTION_NAMES = {};
  
    OPTION_NAMES : ['SPHERE']
   // OPTION_NAMES['option_bracelet_torus'] = 'TORUS';
   // OPTION_NAMES['option_bracelet_cube'] = 'CUBE';
   // OPTION_NAMES['option_bracelet_cylinder'] = 'CYLINDER';
        ...
        this._api.getNodeMap(function(err, result) {
            ...
            for (var i = 0, l = config.OPTION_PREFIXES.length; i < l; i++) {
                ...
                if (prefix === 'option_bracelet_') {
                    $('.options').append('<h2 style = "width:200px" class ="ModelClass">Choose model -'+ optionModel.get('name')+ '</h2>');
                }
                if (prefix === 'option_coque_') {
                    $('.options').append('<h2>Choose option</h2>');
                }
...
},{"../collections/Options":5,"../config.js":6,"../models/Option":7,"./Options":10,"./Select":11,"backbone":2,"jquery":3,"underscore":4}],9:[function(require,module,exports){
'use strict';
...
},{"../config.js":6,"backbone":2,"jquery":3,"underscore":4}],10:[function(require,module,exports){
'use strict';
...
var OptionsView = Backbone.View.extend({
    ...
    onOptionClick: function(e) {
        ...
        var index = this.config.OPTION_ORDER.indexOf(name)
        alert(index);
        $('.ModelClass').html('Choose model - '  + name)
        this.model.each(function(model) {
            
            model.set('selected', model.get('id') === id);
           
            //this.modelType = "Bindu";
        });
    }
});
...
},{"./Option":9,"backbone":2,"jquery":3,"underscore":4}],11:[function(require,module,exports){
'use strict';
...
},{"../config.js":6,"backbone":2,"jquery":3,"underscore":4}]},{},[1]);
